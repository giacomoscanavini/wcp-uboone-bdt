...
#include "WCPLEEANA/WienerSVD.h" //core implementation of Wiener-SVD
#include "WCPLEEANA/Util.h" // utilities
...
int main(int argc, char** argv)
{
    ...
    std::cout<<"~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"<<std::endl;
    std::cout<<"ATTENTION: This is for FAKE DATA SETS ONLY!!!!!!!!!!!!!!!!!!!!!"<<std::endl;
    std::cout<<"~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"<<std::endl;
    ...
    // covariance matrix of measured spectrum in histrogram format (fake data set, limited systematics)
    TH2D* cov = (TH2D*)f->Get("hcov_tot_lim");
